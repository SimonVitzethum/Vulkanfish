...
public final class NgxBridge {
    ...
    private final MethodHandle init, error, dlaa, rr, fg, shutdown;
    ...
    private NgxBridge(SymbolLookup lib) {
        ...
        rr = l.downcallHandle(lib.find("vfngx_rr").orElseThrow(), FunctionDescriptor.of(I,
                J, I, I, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, F, F, I));
     ...
     */
    public int rayReconstruction(long cmd, int w, int h, long[] images, long[] views, int[] formats, float[] matrices,
        ...
        try {
            ...
            return (int) rr.invokeExact(cmd, w, h, rrImages, rrViews, rrFormats, rrMatrices, jx, jy, reset ? 1 : 0);
        } catch (Throwable t) {
            return -100;
        }
    }
